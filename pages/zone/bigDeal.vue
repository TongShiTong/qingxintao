	...
	<view class="page">
		<view class="box01">
			...
			<view class="headBox">
				...
				<view class="headTitle">大牌抢购</view>
...
<style>
	...
	.conBox{background: #f7f7f5;padding: 40rpx 20rpx 20rpx;}
	...
	.goodItem{display: flex;align-items: center;justify-content: space-between;margin-bottom: 44rpx;background: #fff;}
